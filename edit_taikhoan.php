...
<!-- Mirrored from wphix.com/html/ecomart-prev/ecomart/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 14:04:30 GMT -->
<head>
   <meta charset="utf-8">
...
<body>
   ...
   <?php
      ...
      ?>
         <li><a href="#"><?= $user ?></a> / <a href="index.php?act=mybill" class="text-btn"> My account / </a> <a href="index.php?act=thoat">Logout / </a>
                  ...
                  <div class="header-main-content-wrapper">
                     <div class="header-main-left header-main-left-header1">
                        <div class="header-logo header1-logo">
                           <a href="index.php" class="logo-bl"><img width="150px" src="assets/img/logo/GroupThree.png"
                                 alt="logo-img"></a>
                        </div>
            ...
            ?>
                  ...
                  <div class="signup-form-wrapper">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="signup-wrapper">
                              <input type="text" placeholder="User" name="user" value="<?=$user ?>">
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="signup-wrapper">
                        ...
                        <div class="">
                              ...
                              <input type="submit" name="capnhat" value="Cập nhật" style="width: 100%;border-radius:4px;" class="hoverr" >
                           </div>
                     </div>
                     ...
                     <div class="acount-login text-center">
                        <span>Already have an account? <a href="index.php?act=dangnhap">Log in</a></span>
                     </div>
