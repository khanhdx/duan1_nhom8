...
<body>
    ...
    <main>
        ...
        <section class="checkout-area pb-70">
            <div class="container container-small">
                <h1 style="text-align: center;">Thank for your order</h1>
            ...
            <div class="table-content table-responsive">
                <div class="col-md-12">
                    <div class="checkout-form-list">
                        ...
                        <li>Code: <?= $bill['code_order'] ?></li>
                        <li>Order date: <?= $bill['ngaydathang'] ?></li>
            ...
            <a href="index.php?act=mybill" style="color:black;"><u>Order details</u></a>
    ...
    <footer data-background="" class="footer1-bg">
        ...
        <form action="index.php?act=huysession" method="POST">
            <input type="submit" name="huysession" value="Quay lai">
            </form>
    </footer>
    <!-- footer area end  -->
