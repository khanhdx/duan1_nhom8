                            ...
                            <div class="breadcrumb-menu">
                                <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                    <ul class="trail-items">
                                        <li class="trail-item trail-begin"><a href="index.html"><span>Cart</span></a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkout-form-list">
                                            ...
                                            <input type="email" placeholder="" name="email" value="<?= $email ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="checkout-form-list">
                                    ...
                                    <table>
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="product-thumbnail"><img width="50px" src="<?= $hinh ?>" alt="img"></td>
                                                ...
                                                echo '<br>' . ' <tr>
                                                   <th colspan="4" style="font-size:20px; margin-top:50px">Total</th>
                                                   <td></td>
                                                   <td></td>
                                                   <td>$' . $tong . '</td>
                                                   <td></td>
                                ...
                                <div class="payment-method">
                                    <div class="accordion" id="checkoutAccordion">
                                        <table>
                                            ...
                                            <tr><input type="radio" value="1" name="pttt" checked> payment upon delivery</tr> <br>
                                            <tr><input type="radio" value="2" name="pttt"> online payment</tr>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="order-button-payment mt-20">
                                        <!-- <button type="submit" class="fill-btn">Place order</button> -->
                                        <input type="submit" name="dongydathang" value="Place order" class="submit-btn" style="border-radius: 4px;">
                                    </div>
                                </div>
                            </div>
                        </div>
