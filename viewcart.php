                     ...
                     <div class="breadcrumb-menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                           <ul class="trail-items">
                              <li class="trail-item trail-begin"><a href="index.php"><span>Product Details</span></a></li>
               ...
               <div class="col-12">
                  ...
                  <div class="cart-page-total">
                     ...
                     if (isset($_SESSION['user'])) {
                        extract($_SESSION['user']);
                        if ($_SESSION['mycart']!= []) {
                     ?> <a href="index.php?act=bill"><input class="border-btn" type="button" value="Proceed to checkout"></a>
                      <a href="index.php?act=delorder" ><input type="submit" name="Dell" class="border-btn" value="Del all"></a>
                     
                     <?php

                  }else{
                     echo "  <p style='font-size: 50px;margin-top: 50px;'>No Product</p> ";
                  }
                         } else {
                              echo "  <p style='font-size: 50px;margin-top: 50px;'>You must log in</p> ";
                             } ?>
                  </div>
