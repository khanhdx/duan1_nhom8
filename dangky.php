            ...
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  ...
                  <div class="signup-form-wrapper">
                     ...
                     <div class="mb-20">
                        <!-- <button class="sing-btn" type="submit" name="dangky">Register now</button> -->
                        <input type="submit" name="dangky" class="sing-btn" value="Register now" style="background-color: black;color:white;border-radius:5px">
                     </div>
