...
<!-- Mirrored from wphix.com/html/ecomart-prev/ecomart/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 Nov 2023 14:04:29 GMT -->
    ...
    <header class="header1">
        <div class="header-top d-none d-md-block">
            ...
            <header class="header1">
                ...
                ?>
                    <li><a href="#"> <?= $user ?></a> / <a href="index.php?act=mybill" class="text-btn"> My account / </a> <a href="index.php?act=thoat">Logout / </a><a href="index.php">Home</a></li>
                    <hr>
            <?php
                } else {
                ?>
        ...
        <section class="checkout-area pb-70">
            <div class="container container-small">
                ...
                <table class="table">
                    ...
                    <!-- <span style="font-size: 100px;margin-left:100px;">:))</span> -->

                    <table class="table" style="text-align: center;">

                        <thead>
                            <tr>
                                <th class="product-thumbnail">Code orders</th>
                               
                                <!-- <th class="product-price">Number of orders</th> -->
                                <th class="product-quantity">Total Order</th>
                        ...
                        if (is_array($listbill)) {
                            foreach ($listbill as $bill) {
                                ...
                                $details = "index.php?act=mydetails&id=" . $id;
                                if ($bill_status === 0 || $bill_status === 1) {
                        ?>
                                    <tr>
                                        <td class="product-code-order"><?= $code_order ?></td>
                                        <td class="product-count text-center">$<?= $total ?></td>
                                        <td class="product-subtotal"><?= $ttdh ?></td>
                                        <td class="product-date"><?= $ngaydathang ?></td>
                                        <td class="product-subtotal"><a style="color: Blue;" href="<?= $details ?>"><u>Details</u></a></td>
                                        <td class="product-button">
                                            <form action="index.php?act=updatestatus" method="POST">
                                                ...
                                                <input type="submit" value="Bill Delete" name="capnhat">
                                            </form>
                                        </td>
