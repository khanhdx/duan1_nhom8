...
<body>
    ...
    <header class="header1">
        <div class="header-top d-none d-md-block">
            ...
            ?>
                <li><a href="#"> <?= $user ?></a> / <a href="index.php?act=mybill" class="text-btn"> Order details / </a> <a href="index.php?act=thoat">Logout</a></li>
                <hr> <?php
                    } else {
                        ?>
                    ...
                    <div class="col-12">
                        <div class="table-content table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    foreach ($list_sanpham_idbill as $sanpham_idbill) {
                                        extract($sanpham_idbill);
                                        $hinh = $img_path . $img;
                                    ?>
                                        <tr>
                                            <td class="product-img"><img width="100px" src="<?= $hinh ?>" alt="<?= $name ?> Image"></td>
                            ...
                            <a href="index.php?act=mybill"><button type="submit" style="margin-top: 20px;" class="fill-btn">Back to bill</button></a>
                        </div>
